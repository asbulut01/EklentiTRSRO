...
_y = 26
lblGeneral = QtBind.createLabel(gui,'General(0)',220,_y)
cbxIgnoreGeneral = QtBind.createCheckBox(gui,'cbxIgnoreGeneral_clicked','Yoksay',315,_y)
cbxOnlyCountGeneral = QtBind.createCheckBox(gui,'cbxOnlyCountGeneral_clicked','Tercih Et',405,_y)
_y+=20
lblChampion = QtBind.createLabel(gui,'Champion(1)',220,_y)
cbxIgnoreChampion = QtBind.createCheckBox(gui,'cbxIgnoreChampion_clicked','Yoksay',315,_y)
cbxOnlyCountChampion = QtBind.createCheckBox(gui,'cbxOnlyCountChampion_clicked','Tercih Et',405,_y)
_y+=20
lblGiant = QtBind.createLabel(gui,'Giant(4)',220,_y)
cbxIgnoreGiant = QtBind.createCheckBox(gui,'cbxIgnoreGiant_clicked','Yoksay',315,_y)
cbxOnlyCountGiant = QtBind.createCheckBox(gui,'cbxOnlyCountGiant_clicked','Tercih Et',405,_y)
_y+=20
lblTitan = QtBind.createLabel(gui,'Titan(5)',220,_y)
cbxIgnoreTitan = QtBind.createCheckBox(gui,'cbxIgnoreTitan_clicked','Yoksay',315,_y)
cbxOnlyCountTitan = QtBind.createCheckBox(gui,'cbxOnlyCountTitan_clicked','Tercih Et',405,_y)
_y+=20
lblStrong = QtBind.createLabel(gui,'Strong(6)',220,_y)
cbxIgnoreStrong = QtBind.createCheckBox(gui,'cbxIgnoreStrong_clicked','Yoksay',315,_y)
cbxOnlyCountStrong = QtBind.createCheckBox(gui,'cbxOnlyCountStrong_clicked','Tercih Et',405,_y)
_y+=20
lblElite = QtBind.createLabel(gui,'Elite(7)',220,_y)
cbxIgnoreElite = QtBind.createCheckBox(gui,'cbxIgnoreElite_clicked','Yoksay',315,_y)
cbxOnlyCountElite = QtBind.createCheckBox(gui,'cbxOnlyCountElite_clicked','Tercih Et',405,_y)
_y+=20
lblUnique = QtBind.createLabel(gui,'Unique(8)',220,_y)
cbxIgnoreUnique = QtBind.createCheckBox(gui,'cbxIgnoreUnique_clicked','Yoksay',315,_y)
cbxOnlyCountUnique = QtBind.createCheckBox(gui,'cbxOnlyCountUnique_clicked','Tercih Et',405,_y)
_y+=20
lblParty = QtBind.createLabel(gui,'Party(16)',220,_y)
cbxIgnoreParty = QtBind.createCheckBox(gui,'cbxIgnoreParty_clicked','Yoksay',315,_y)
cbxOnlyCountParty = QtBind.createCheckBox(gui,'cbxOnlyCountParty_clicked','Tercih Et',405,_y)
_y+=20
lblChampionParty = QtBind.createLabel(gui,'ChampionParty(17)',220,_y)
cbxIgnoreChampionParty = QtBind.createCheckBox(gui,'cbxIgnoreChampionParty_clicked','Yoksay',315,_y)
cbxOnlyCountChampionParty = QtBind.createCheckBox(gui,'cbxOnlyCountChampionParty_clicked','Tercih Et',405,_y)
_y+=20
lblGiantParty = QtBind.createLabel(gui,'GiantParty(20)',220,_y)
...
def btnAddMob_clicked():
	...
	if text and not ListContains(text,lstMobsData):
		...
		saveConfigs()
		log('Plugin: Canavar Eklendi ['+text+']')
...
def btnRemMob_clicked():
	...
	if selected:
		...
		saveConfigs()
		log('Plugin: Canavar Silindi ['+selected+']')
