...
def checkInv(arg, player):
    ...
    if items:
        for item in items:
            if item is not None:
                ...
                if "Mermaid’s tears" in item['name']:
                ...
                if "Evil’s heart" in item['name']:
                    card28 += item['quantity']
                if "Vindictive sprit’s bead" in item['name']:
                    card29 += item['quantity']
                if "Hook hand" in item['name']:
                    card30 += item['quantity']
                if "Sereness’s tears" in item['name']:
                    card31 += item['quantity']
                if "Commander’s patch" in item['name']:
        ...
        for p in pets.keys():
            ...
            if pet['type'] in 'pick':
                for petItems in pet['items']:
                    if petItems != None:
                        if "Incomplete" in petItems['name'] and "Weapon" in petItems['name']:
                            weapon5 += petItems['quantity']
                        if "Incomplete" in petItems['name'] and "Armor" in petItems['name']:
                            protector5 += petItems['quantity']
                        if "Incomplete" in petItems['name'] and "Accessory" in petItems['name']:
                            accessory5 += petItems['quantity']
                        if "Incomplete" in petItems['name'] and "Shield" in petItems['name']:
                            shield5 += petItems['quantity']
                        if "Lv.8" in petItems['name'] and "Weapon" in petItems['name']:
                            weapon1 += petItems['quantity']
                        if "Lv.8" in petItems['name'] and "Armor" in petItems['name']:
                            protector1 += petItems['quantity']
                        if "Lv.8" in petItems['name'] and "Accessory" in petItems['name']:
                            accessory1 += petItems['quantity']
                        if "Lv.8" in petItems['name'] and "Shield" in petItems['name']:
                            shield1 += petItems['quantity']
                        if "Lv.9" in petItems['name'] and "Weapon" in petItems['name']:
                            weapon2 += petItems['quantity']
                        if "Lv.9" in petItems['name'] and "Armor" in petItems['name']:
                            protector2 += petItems['quantity']
                        if "Lv.9" in petItems['name'] and "Accessory" in petItems['name']:
                            accessory2 += petItems['quantity']
                        if "Lv.9" in petItems['name'] and "Shield" in petItems['name']:
                            shield2 += petItems['quantity']
                        if "Lv.10" in petItems['name'] and "Weapon" in petItems['name']:
                            weapon3 += petItems['quantity']
                        if "Lv.10" in petItems['name'] and "Armor" in petItems['name']:
                            protector3 += petItems['quantity']
                        if "Lv.10" in petItems['name'] and "Accessory" in petItems['name']:
                            accessory3 += petItems['quantity']
                        if "Lv.10" in petItems['name'] and "Shield" in petItems['name']:
                            shield3 += petItems['quantity']
                        if "Lv.11" in petItems['name'] and "Weapon" in petItems['name']:
                            weapon4 += petItems['quantity']
                        if "Lv.11" in petItems['name'] and "Armor" in petItems['name']:
                            protector4 += petItems['quantity']
                        if "Lv.11" in petItems['name'] and "Accessory" in petItems['name']:
                            accessory4 += petItems['quantity']
                        if "Lv.11" in petItems['name'] and "Shield" in petItems['name']:
                            shield4 += petItems['quantity']
                        if "12th Grade Enhancer" in petItems['name'] and "Weapon" in petItems['name']:
                            eweapon1 += petItems['quantity']
                        if "12th Grade Enhancer" in petItems['name'] and "Armor" in petItems['name']:
                            eprotector1 += petItems['quantity']
                        if "12th Grade Enhancer" in petItems['name'] and "Accessory" in petItems['name']:
                            eaccessory1 += petItems['quantity']
                        if "12th Grade Enhancer" in petItems['name'] and "Shield" in petItems['name']:
                            eshield1 += petItems['quantity']
                        if "13th Grade Enhancer" in petItems['name'] and "Weapon" in petItems['name']:
                            eweapon2 += petItems['quantity']
                        if "13th Grade Enhancer" in petItems['name'] and "Armor" in petItems['name']:
                            eprotector2 += petItems['quantity']
                        if "13th Grade Enhancer" in petItems['name'] and "Accessory" in petItems['name']:
                            eaccessory2 += petItems['quantity']
                        if "13th Grade Enhancer" in petItems['name'] and "Shield" in petItems['name']:
                            eshield2 += petItems['quantity']
                        if "14th Grade Enhancer" in petItems['name'] and "Weapon" in petItems['name']:
                            eweapon3 += petItems['quantity']
                        if "14th Grade Enhancer" in petItems['name'] and "Armor" in petItems['name']:
                            eprotector3 += petItems['quantity']
                        if "14th Grade Enhancer" in petItems['name'] and "Accessory" in petItems['name']:
                            eaccessory3 += petItems['quantity']
                        if "14th Grade Enhancer" in petItems['name'] and "Shield" in petItems['name']:
                            eshield3 += petItems['quantity']
                        if "15th Grade Enhancer" in petItems['name'] and "Weapon" in petItems['name']:
                            eweapon4 += petItems['quantity']
                        if "15th Grade Enhancer" in petItems['name'] and "Armor" in petItems['name']:
                            eprotector4 += petItems['quantity']
                        if "15th Grade Enhancer" in petItems['name'] and "Accessory" in petItems['name']:
                            eaccessory4 += petItems['quantity']
                        if "15th Grade Enhancer" in petItems['name'] and "Shield" in petItems['name']:
                            eshield4 += petItems['quantity']
                        if "16th Grade Enhancer" in petItems['name'] and "Weapon" in petItems['name']:
                            eweapon5 += petItems['quantity']
                        if "16th Grade Enhancer" in petItems['name'] and "Armor" in petItems['name']:
                            eprotector5 += petItems['quantity']
                        if "16th Grade Enhancer" in petItems['name'] and "Accessory" in petItems['name']:
                            eaccessory5 += petItems['quantity']
                        if "16th Grade Enhancer" in petItems['name'] and "Shield" in petItems['name']:
                            eshield5 += petItems['quantity']
                        if "17th Grade Enhancer" in petItems['name'] and "Weapon" in petItems['name']:
                            eweapon6 += petItems['quantity']
                        if "17th Grade Enhancer" in petItems['name'] and "Armor" in petItems['name']:
                            eprotector6 += petItems['quantity']
                        if "17th Grade Enhancer" in petItems['name'] and "Accessory" in petItems['name']:
                            eaccessory6 += petItems['quantity']
                        if "17th Grade Enhancer" in petItems['name'] and "Shield" in petItems['name']:
                            eshield6 += petItems['quantity']
                        ...
                        if "Lvl.11" in petItems['name'] and "Str" in petItems['name']:
                            str11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "Str" in petItems['name']:
                            str10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "Str" in petItems['name']:
                            str9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "Str" in petItems['name']:
                            str8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "Int" in petItems['name']:
                            int11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "Int" in petItems['name']:
                            int10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "Int" in petItems['name']:
                            int9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "Int" in petItems['name']:
                            int8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "master" in petItems['name']:
                            master11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "master" in petItems['name']:
                            master10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "master" in petItems['name']:
                            master9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "master" in petItems['name']:
                            master8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "strikes" in petItems['name']:
                            strikes11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "strikes" in petItems['name']:
                            strikes10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "strikes" in petItems['name']:
                            strikes9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "strikes" in petItems['name']:
                            strikes8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "discipline" in petItems['name']:
                            discipline11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "discipline" in petItems['name']:
                            discipline10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "discipline" in petItems['name']:
                            discipline9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "discipline" in petItems['name']:
                            discipline8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "penetration" in petItems['name']:
                            penetration11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "penetration" in petItems['name']:
                            penetration10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "penetration" in petItems['name']:
                            penetration9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "penetration" in petItems['name']:
                            penetration8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "dodging" in petItems['name']:
                            dodging11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "dodging" in petItems['name']:
                            dodging10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "dodging" in petItems['name']:
                            dodging9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "dodging" in petItems['name']:
                            dodging8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "stamina" in petItems['name']:
                            stamina11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "stamina" in petItems['name']:
                            stamina10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "stamina" in petItems['name']:
                            stamina9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "stamina" in petItems['name']:
                            stamina8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "magic" in petItems['name']:
                            magic11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "magic" in petItems['name']:
                            magic10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "magic" in petItems['name']:
                            magic9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "magic" in petItems['name']:
                            magic9 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "fogs" in petItems['name']:
                            fogs11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "fogs" in petItems['name']:
                            fogs10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "fogs" in petItems['name']:
                            fogs9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "fogs" in petItems['name']:
                            fogs8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "air" in petItems['name']:
                            air11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "air" in petItems['name']:
                            air10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "air" in petItems['name']:
                            air9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "air" in petItems['name']:
                            air8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "fire" in petItems['name']:
                            fire11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "fire" in petItems['name']:
                            fire10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "fire" in petItems['name']:
                            fire9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "fire" in petItems['name']:
                            fire8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "immunity" in petItems['name']:
                            immunity11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "immunity" in petItems['name']:
                            immunity10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "immunity" in petItems['name']:
                            immunity9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "immunity" in petItems['name']:
                            immunity8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "revival" in petItems['name']:
                            revival11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "revival" in petItems['name']:
                            revival10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "revival" in petItems['name']:
                            revival9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "revival" in petItems['name']:
                            revival8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "courage" in petItems['name']:
                            courage11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "courage" in petItems['name']:
                            courage10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "courage" in petItems['name']:
                            courage9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "courage" in petItems['name']:
                            courage8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "warriors" in petItems['name']:
                            warriors11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "warriors" in petItems['name']:
                            warriors10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "warriors" in petItems['name']:
                            warriors9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "warriors" in petItems['name']:
                            warriors8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "philosophy" in petItems['name']:
                            philosophy11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "philosophy" in petItems['name']:
                            philosophy10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "philosophy" in petItems['name']:
                            philosophy9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "philosophy" in petItems['name']:
                            philosophy8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "meditation" in petItems['name']:
                            meditation11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "meditation" in petItems['name']:
                            meditation10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "meditation" in petItems['name']:
                            meditation9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "meditation" in petItems['name']:
                            meditation8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "challenge" in petItems['name']:
                            challenge11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "challenge" in petItems['name']:
                            challenge10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "challenge" in petItems['name']:
                            challenge9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "challenge" in petItems['name']:
                            challenge8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "focus" in petItems['name']:
                            focus11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "focus" in petItems['name']:
                            focus10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "focus" in petItems['name']:
                            focus9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "focus" in petItems['name']:
                            focus8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "flesh" in petItems['name']:
                            flesh11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "flesh" in petItems['name']:
                            flesh10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "flesh" in petItems['name']:
                            flesh9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "flesh" in petItems['name']:
                            flesh8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "life" in petItems['name']:
                            life11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "life" in petItems['name']:
                            life10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "life" in petItems['name']:
                            life9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "life" in petItems['name']:
                            life8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "mind" in petItems['name']:
                            mind11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "mind" in petItems['name']:
                            mind10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "mind" in petItems['name']:
                            mind9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "mind" in petItems['name']:
                            mind8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "spirit" in petItems['name']:
                            spirit11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "spirit" in petItems['name']:
                            spirit10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "spirit" in petItems['name']:
                            spirit9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "spirit" in petItems['name']:
                            spirit8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "Attribute stone of dodging" in petItems['name']:
                            dodgings11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "Attribute stone of dodging" in petItems['name']:
                            dodgings10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "Attribute stone of dodging" in petItems['name']:
                            dodgings9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "Attribute stone of dodging" in petItems['name']:
                            dodgings8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "agility" in petItems['name']:
                            agility11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "agility" in petItems['name']:
                            agility10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "agility" in petItems['name']:
                            agility9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "agility" in petItems['name']:
                            agility8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "training" in petItems['name']:
                            training11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "training" in petItems['name']:
                            training10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "training" in petItems['name']:
                            training9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "training" in petItems['name']:
                            training8 += petItems['quantity']
                        if "Lvl.11" in petItems['name'] and "prayer" in petItems['name']:
                            prayer11 += petItems['quantity']
                        if "Lvl.10" in petItems['name'] and "prayer" in petItems['name']:
                            prayer10 += petItems['quantity']
                        if "Lvl.9" in petItems['name'] and "prayer" in petItems['name']:
                            prayer9 += petItems['quantity']
                        if "Lvl.8" in petItems['name'] and "prayer" in petItems['name']:
                            prayer8 += petItems['quantity']
                        if "Pandora's Box" in petItems['name']:
                            pandora += petItems['quantity']
                        if "Monster Summon Scroll (ekip kullanir)" in petItems['name']:
                            ms += petItems['quantity']
                        if "Magic stone of steady(Lvl.11)" in petItems['name']:
                            steadyst11 += petItems['quantity']
                        if "Magic stone of luck(Lvl.11)" in petItems['name']:
                            luckst11 += petItems['quantity']
                        if "Magic stone of steady(Lvl.10)" in petItems['name']:
                            steadyst10 += petItems['quantity']
                        if "Magic stone of luck(Lvl.10)" in petItems['name']:
                            luckst10 += petItems['quantity']
                        if "Magic stone of steady(Lvl.9)" in petItems['name']:
                            steadyst9 += petItems['quantity']
                        if "Magic stone of luck(Lvl.9)" in petItems['name']:
                            luckst9 += petItems['quantity']
                        if "Magic stone of steady(Lvl.8)" in petItems['name']:
                            steadyst8 += petItems['quantity']
                        if "Magic stone of luck(Lvl.8)" in petItems['name']:
                            luckst8 += petItems['quantity']
                        if "ITEM_ETC_E090722_" in petItems['servername'] and "ICECREAM" in petItems['servername']:
                            cream += petItems['quantity']
                        if "Lucky Box" in petItems['name']:
                            luckybox += petItems['quantity']
                        if "Genie’s Lamp" in petItems['name']:
                            lamp += petItems['quantity']
                        if "Dirty Lamp" in petItems['name']:
                            dLamp += petItems['quantity']
                        if "Red tears" in petItems['name']:
                            card1 += petItems['quantity']
                        if "Western scriptures" in petItems['name']:
                            card2 += petItems['quantity']
                        if "Togui mask" in petItems['name']:
                            card3 += petItems['quantity']
                        if "Red talisman" in petItems['name']:
                            card4 += petItems['quantity']
                        if "Puppet" in petItems['name']:
                            card5 += petItems['quantity']
                        if "Dull kitchen knife" in petItems['name']:
                            card6 += petItems['quantity']
                        if "Elder staff" in petItems['name']:
                            card7 += petItems['quantity']
                        if "Spell paper" in petItems['name']:
                            card8 += petItems['quantity']
                        if "Fire flower" in petItems['name']:
                            card9 += petItems['quantity']
                        if "Horned cattle" in petItems['name']:
                            card10 += petItems['quantity']
                        if "Flame of oblivion" in petItems['name']:
                            card11 += petItems['quantity']
                        if "Flame paper" in petItems['name']:
                            card12 += petItems['quantity']
                        if "Hearthstone flame" in petItems['name']:
                            card13 += petItems['quantity']
                        if "Enchantress necklace" in petItems['name']:
                            card14 += petItems['quantity']
                        if "Honghaeah armor" in petItems['name']:
                            card15 += petItems['quantity']
                        if "Fire dragon sword" in petItems['name']:
                            card16 += petItems['quantity']
                        if "Silver pendant" in petItems['name']:
                            card17 += petItems['quantity']
                        if "Cobalt emerald" in petItems['name']:
                            card18 += petItems['quantity']
                        if "Logbook" in petItems['name']:
                            card19 += petItems['quantity']
                        if "Love letter" in petItems['name']:
                            card20 += petItems['quantity']
                        if "Portrait of a woman" in petItems['name']:
                            card21 += petItems['quantity']
                        if "Jewelry box" in petItems['name']:
                            card22 += petItems['quantity']
                        if "Diamond watch" in petItems['name']:
                            card23 += petItems['quantity']
                        if "Mermaid’s tears" in petItems['name']:
                            card24 += petItems['quantity']
                        if "Broken Key" in petItems['name']:
                            card25 += petItems['quantity']
                        if "Large tong" in petItems['name']:
                            card26 += petItems['quantity']
                        if "Phantom harp" in petItems['name']:
                            card27 += petItems['quantity']
                        if "Evil’s heart" in petItems['name']:
                            card28 += petItems['quantity']
                        if "Vindictive sprit’s bead" in petItems['name']:
                            card29 += petItems['quantity']
                        if "Hook hand" in petItems['name']:
                            card30 += petItems['quantity']
                        if "Sereness’s tears" in petItems['name']:
                            card31 += petItems['quantity']
                        if "Commander’s patch" in petItems['name']:
                            card32 += petItems['quantity']
                        if "Faded Bead" in petItems['name']:
    ...
    if arg == "9Stat2":
        phBotChat.Private(player,"8DG LIFE " + str(life9) + " , MIND " + str(mind9) + " , SPIRIT " + str(spirit9) + " , DODGING " + str(dodgings9) + " , AGILITY " + str(agility9) + " , TRAINING " + str(training9) + " , PRAYER " + str(prayer9))
    if arg == "10Stat2":
        phBotChat.Private(player,"8DG LIFE " + str(life10) + " , MIND " + str(mind10) + " , SPIRIT " + str(spirit10) + " , DODGING " + str(dodgings10) + " , AGILITY " + str(agility10) + " , TRAINING " + str(training10) + " , PRAYER " + str(prayer10))
    if arg == "11Stat2":
        phBotChat.Private(player,"8DG LIFE " + str(life11) + " , MIND " + str(mind11) + " , SPIRIT " + str(spirit11) + " , DODGING " + str(dodgings11) + " , AGILITY " + str(agility11) + " , TRAINING " + str(training11) + " , PRAYER " + str(prayer11))
    if arg == "Coin":
...
def handle_chat(t, player, msg):
    if player and lstLeaders_exist(player) or t == 100:
        if msg == "ENV":
            ...
            phBotChat.Private(player,"Seviye: " + str(level) + " - Tecrube : %" + str("{:.2f}".format(exp)))
        elif msg == "JOBEXP":
            data = get_character_data()
