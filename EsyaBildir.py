            ...
            if pet['type'] in 'pick':
                for petItems in pet['items']:
                    if petItems != None:
                        ...
                        if "Mermaid’s" in petItems['name'] and "tears" in petItems['name']:
                        ...
                        if "Evil’s" in petItems['name'] and "heart" in petItems['name']:
                            card28 += petItems['quantity']
                        if "Vindictive" in petItems['name'] and "sprit’s bead" in petItems['name']:
                            card29 += petItems['quantity']
                        if "Hook hand" in petItems['name']:
                            card30 += petItems['quantity']
                        if "Sereness’s" in petItems['name'] and "tears" in petItems['name']:
                            card31 += petItems['quantity']
                        if "Commander’s" in petItems['name'] and "patch" in petItems['name']:
