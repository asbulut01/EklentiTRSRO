...
QtBind.createButton(gui, 'store_gold_storage', 'Depola', gui_store_take_gold_position_x + 15 + 105,
                    gui_store_take_gold_position_y + 20 + 20)
QtBind.createButton(gui, 'GuildBank Al', 'Al', gui_store_take_gold_position_x + 15 + 105 + 80,
                    gui_store_take_gold_position_y + 20 + 20)
QtBind.createLabel(gui, 'Guild Depo', gui_store_take_gold_position_x + 15, gui_store_take_gold_position_y + 20 + 50)
store_take_gold_guild_storage_amount_widget = QtBind.createLineEdit(gui,
                                                                    ...
                                                                    22)
QtBind.createButton(gui, 'store_gold_guild_storage', 'Depola', gui_store_take_gold_position_x + 15 + 105,
